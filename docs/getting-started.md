# Getting Started with Zentinel Agent Python SDK

This guide will walk you through creating your first Zentinel agent in Python.
...
- [GitHub Issues](https://github.com/zentinelproxy/zentinel-agent-python-sdk/issues)
- [Zentinel Documentation](https://zentinel.raskell.io/docs)
